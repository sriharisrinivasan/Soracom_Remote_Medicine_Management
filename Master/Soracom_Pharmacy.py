...
class Soracom_Pharamacy_Gui():
    def __init__(self,master):
        ...
        self.Button_Open_Camera = Button(self.master,width=60,font="Calibri 12 bold",text="Capture Image",fg="black",bg="yellow",state='normal',command=self.Cmd_Thread_Capture_Image)
        self.Button_Open_Camera = Button(self.master,width=60,font="Calibri 12 bold",text="Update Database",fg="black",bg="yellow",state='normal',command=self.Cmd_Update_Database)
        ...
        self.Button_Open_Camera.grid(row=1,column=0,padx=0,pady=0,sticky=E+W+N+S)
        self.Button_Open_Camera.grid(row=2,column=0,padx=0,pady=0,sticky=E+W+N+S)
    ...
    def Cmd_Send_Medicine_Info(self):
        ...
        self.Button_Set_Output_PushPull_Low.config(relief="raised",text="Medicine Info Sent",bg="green",fg="black")
        self.enable(self.master.winfo_children())
        self.master.update_idletasks()
